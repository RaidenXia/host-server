...
# _vad_path = "iic/speech_fsmn_vad_zh-cn-16k-common-pytorch"
_vad_path = "F:/projects/tableAI/Demo4Echo-main/AIChat_demo/Server/models/FunAudioLLM/iic/speech_fsmn_vad_zh-cn-16k-common-pytorch"

class VADModel:
    def __init__(self, device="cuda", vad_model_path=_vad_path, frame_duration_ms=200, sample_rate=16000,
